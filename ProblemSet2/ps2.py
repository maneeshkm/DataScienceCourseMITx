...
print  runSimulation(10, 10, 20, 20, 0.75, 30, StandardRobot)
...
class RandomWalkRobot(Robot):
    ...
    def __init__(self, room, speed):
        ...
        self.robotRoom.cleanTileAtPosition(self.getRobotPosition())
...
print  runSimulation(1, 1, 10, 10, 0.15, 30, RandomWalkRobot)
